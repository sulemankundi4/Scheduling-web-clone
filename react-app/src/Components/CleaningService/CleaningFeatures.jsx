...
const features = [
  { title: "SMS and Email Notifications (Free)", image: smsEmailNotif, description: "No-shows are very common in cleaning service businesses. Make sure your clients come to the scheduled appointment by sending automatic SMS, Email, or WhatsApp reminders. Create custom notifications and follow-ups and interact with your customers in your brand voice." },
  ...
  { title: "Coupons", image: coupons, description: "Offering discounts or free appointments to your customers is hassle-free with Trafft scheduling software for cleaning companies. Simply define the value of each coupon to provide exclusive deals." },
  { title: "Invoices", image: invoices, description: "Manage and create different roles for your employees. For example, limit the permissions and pages your users can access and create different levels of authority and management within your team." },
  { title: "Rescheduling and Canceling", image: resceduling, description: "Reduce no-shows and prevent last-minute cancellations by allowing your customers to cancel and reschedule an appointment in the cleaning service appointments software in a few clicks." },
  { title: "Insightful Dashboard (Free)", image: dashboard, description: "Get a quick overview of your business's performance with the Trafft cleaning services scheduling software. The dashboard provides a clear view of your booked appointments, available time slots, and revenue generated. This helps you make data-driven decisions and optimize your business operations." },
  { title: "Multiple Locations", image: multipleLocations, description: "If you have cleaning services in multiple locations, you can manage all your business locations with one Trafft account. Also, your employees can work in a few locations and you can create their schedule for different locations." },
  { title: "Online Payments", image: onlinePayments, description: "Get paid for your services online and on-site and sends invoices automatically. Trafft seamlessly integrates with trusted payment providers such as PayPal, Stripe, Mollie, and Authorize.net, making it effortless to collect payments online in a fast, secure, and user-friendly manner." },
];
