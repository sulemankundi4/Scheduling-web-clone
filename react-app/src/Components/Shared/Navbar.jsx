      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="lg:hidden">
            <button onClick={handleMenuToggle}>{!menuOpen && <Menu size={24} />}</button>
          </div>
        </div>
        ...
        <div className={menuOpen ? "block" : "hidden"}>
          ...
          {/* Sidebar */}
          <aside ref={sidebarRef} className="fixed left-0 top-0 h-full w-72 max-w-[90vw] bg-white z-50 shadow-lg flex flex-col lg:hidden transition-transform duration-300 ease-in-out" style={{ transform: "translateX(-100%)" }}>
