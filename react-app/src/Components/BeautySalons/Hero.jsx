...
import heroBg from "../../assets/Images/salons-hero.webp";
  ...
  return (
    <>
      <div className="relative bg-cover bg-center text-white min-h-screen" style={{ backgroundImage: `url(${heroBg})` }}>
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-[#010a2c]/90 z-0"></div>
          ...
          <div className="container mx-auto px-4 py-16 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                <span className="text-yellow-400">Salon management software</span> every modern salon business needs
              </h1>
